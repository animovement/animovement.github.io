...
Install all the packages in the *animovement* ecosystem by running:
...
Run `library(animovement)` to load the packages and make them available in
your current R session. 

Some functions also need additional packages to be installed. You can install all these *suggested* packages with `install_suggested_packages()`.
...
::: {.pkg-item}
[![](../assets/logos/aniframe.svg){.pkg-logo-inline}](https://animovement.dev/anicore)

[anicore](https://animovement.dev/anicore){.pkg-name}

The core data structures — S3 classes for representing and manipulating movement data. [Go to package …](https://animovement.dev/anicore){.pkg-go}
:::
