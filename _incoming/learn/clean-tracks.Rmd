...
<!-- TODO: Commented out for now — the outlier-detection workflow is being
reworked. It relied on raw `dx`/`dy` sensor columns, which `read_trackball()`
no longer returns (output is `x`/`y`). Re-enable once the new approach lands.
