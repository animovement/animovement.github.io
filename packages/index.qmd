...
Some functions also need additional packages to be installed. You can install
all these *suggested* packages with `install_suggested_packages()`.
...
::: {.pkg-item}
[![](../assets/logos/anicore.svg){.pkg-logo-inline}](https://animovement.dev/anicore)
