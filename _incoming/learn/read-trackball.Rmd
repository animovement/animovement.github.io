...
<!-- TODO: Commented out for now — this section needs a hosted multi-experiment
dataset (an .xlsx metadata file plus several file pairs) that isn't yet
available via `get_sample_data()`. Re-enable once that sample data exists.
